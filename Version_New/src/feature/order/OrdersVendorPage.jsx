        ...
        <div className="flex flex-col bg-white rounded-lg shadow-lg h-full flex-1 min-w-[250px] mx-2 first:ml-4 last:mr-4">
            ...
            <div className="p-2 space-y-4 flex-1 overflow-y-auto">
                {orders?.length > 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-32 p-4 border-2 border-dashed border-gray-200 rounded-lg bg-gray-50">
                        <svg className="w-10 h-10 text-gray-400 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                        </svg>
                        <p className="text-center text-gray-500 font-medium">No hay órdenes para gestionar</p>
                        <p className="text-center text-gray-400 text-sm mt-1">Las nuevas órdenes aparecerán aquí cuando estén disponibles</p>
                    </div>
                )}
            </div>
        </div>
