...
const Home = () => {
  return (
    <Layout title="Oxindustriales - Inicio">
      <div>
        {/* Hero Section */}
        <section
        ...
        >
          ...
          <div className="relative z-10 bg-black bg-opacity-50 p-8 rounded-lg shadow-lg border border-gray-700">
            ...
            <p className="text-lg mt-4 font-light">Ofrecemos el mejor gas a precios accesibles con la más alta calidad y seguridad.</p>
            <Link
              to="/products"
            ...
            <div className="container mx-auto text-center">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="bg-white p-6 shadow-md rounded-lg">
                  ...
                  <p className="text-gray-600 mt-2">Ofrecemos oxígeno, nitrógeno, argón, helio e hidrógeno con máxima calidad y seguridad.</p>
                </div>
                <div className="bg-white p-6 shadow-md rounded-lg">
                  <FaFlask className="text-green-600 text-6xl mx-auto mb-4" />
                  <h3 className="text-xl font-semibold">Control de Calidad</h3>
                  <p className="text-gray-600 mt-2">Nuestros gases cumplen con las normativas más exigentes para uso industrial y médico.</p>
                </div>
                <div className="bg-white p-6 shadow-md rounded-lg">
                  <FaShippingFast className="text-green-600 text-6xl mx-auto mb-4" />
                  <h3 className="text-xl font-semibold">Entrega Rápida</h3>
                  <p className="text-gray-600 mt-2">Contamos con una logística eficiente para entregas seguras y a tiempo.</p>
                </div>
              </div>
            </div>
          </section>
        ...
        <section className="container mx-auto py-16 px-6 text-center">
          ...
          <p className="text-gray-700 max-w-2xl mx-auto">Si necesitas más información sobre nuestros productos y servicios, no dudes en comunicarte con nosotros.</p>
          <a to="#contacto" className="mt-4 inline-block bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded-lg transition">Escríbenos</a>
        </section>
      </div>
    </Layout>
  );
